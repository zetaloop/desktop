      ...
      >
        <DialogContent>
          <div id="push-protection-error-dialog-description">
            ...
            <p>
              泄露密钥会有风险，请{' '}
              <LinkButton uri="https://docs.github.com/zh/code-security/secret-scanning/working-with-secret-scanning-and-push-protection/working-with-push-protection-in-the-github-ui#resolving-a-blocked-commit">
                从提交和历史记录中清除密钥
              </LinkButton>
              。
            </p>
